...
#define ID_CaeUnsCOOLFluiD  450
{
    ...
    {   PWP_SITE_GROUPNAME,     /* const char *group */
        "COOLFluiD",             /* const char *name */
        MAKEGUID(ID_CaeUnsCOOLFluiD),  /* PWP_UINT32 id */
    ...
    0, //CaeUnsCOOLFluiDVCInfo,            /* CAEP_VCINFO* pVCInfo */
    0, //ARRAYSIZE(CaeUnsCOOLFluiDVCInfo), /* PWP_UINT32 VCCnt */

    /*== const char**    pFileExt;   -- array of valid file extensions */
    /*== PWP_UINT32      ExtCnt;     -- # valid file extensions */
    CaeUnsCOOLFluiDFileExt,            /* const char **pFileExt */
    ARRAYSIZE(CaeUnsCOOLFluiDFileExt), /* PWP_UINT32 ExtCnt */
